...
def try_load_deprecated_user_path_config():
    ...
    try:
        ...
        if deprecated_config_dict.get("default_model", None) == 'leosamsHelloworldSDXL_helloworldSDXL20.safetensors':
...
default_base_model_name = get_config_item_or_set_default(
    key='default_model',
    default_value='leosamsHelloworldSDXL_helloworldSDXL20.safetensors',
